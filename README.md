...
Home: https://www.r4photobiology.info
...
Development: https://bitbucket.org/aphalo/ggspectra
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/r-ggspectra-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-ggspectra-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add r-ggspectra
# for installing globally
pixi global install r-ggspectra
```
...
It is possible to list all of the versions of `r-ggspectra` available on your platform:
...
```
pixi search r-ggspectra --channel conda-forge
```
